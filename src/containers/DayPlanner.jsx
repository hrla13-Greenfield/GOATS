  ...
  renderDay() {
    items = (this.props.choices.dayLoad.map(item => (
      <div className="col-md-6 col-sm-12 col-xs-12 morning row-equal-height" height="300px">
        ...
        <div className="orange">
          {Math.round(item.distance * 0.000621371 * 100) / 100} miles from you </div>
        <h6 className="orange"> Description:{
              item.description.map(item => (<div>{item.title}</div>))
            } </h6>
    ...
    items2 = (this.props.choices.dayLoadtwo.map(item => (
      <div className="col-md-6 col-sm-12 col-xs-12 morning row-equal-height" height="300px">
        ...
        <div className="orange">
          {Math.round(item.distance * 0.000621371 * 100) / 100} miles from you </div>
        <h6 className="orange"> Description:{ item.description.map(item => (
          <div>{item.title}</div>)) } </h6>
        <h6 className="orange"> {item.phone} </h6>
